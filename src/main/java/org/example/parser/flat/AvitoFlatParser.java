...
public class AvitoFlatParser extends BaseFlatParser{
    ...
    public AvitoFlatParser(Connector connector) {
        super(connector);
    }

    @Override
    public Long parsePrice(Document doc) throws ParseException {
    ...
    @Override
    public Double parseSquare(Document doc) throws ParseException {
    ...
    @Override
    public String parseAddress(Document doc) throws ParseException {
    ...
    @Override
    public Long parseRoomsAmount(Document doc) throws ParseException {
    ...
    @Override
    public Long parseFlatFloor(Document doc) throws ParseException {
        return parseFloorParams(doc, "flatFloor","Flat floor is not matched","Flat floor is empty");
    }

    @Override
    public Long parseTotalHouseFloors(Document doc) throws ParseException {
